    ...
    public static class DataSeedExtensions
    {
        ...
        public static ModelBuilder SeedUsers(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, FullName = "Admin User", RoleKey = "admin", Email = "admin@outlook.com", PasswordHash = "AQAAAAEAACcQAAAAECJCSH7Y7+DSAD+UKEnb6fjgOROzppnUpop5/kVMcBDjzOVaLz0vts978iw4ooBhhQ==" }, // Admin123!
                new User { Id = 2, FullName = "Normal User", RoleKey = "user", Email = "user@outlook.com", PasswordHash = "AQAAAAEAACcQAAAAEH2PV/R1HciXgHqwrYcEp/32IrxaQ44wcbBnM6EHK2FXA5wZRYXN6pddtVKNqTpTxg==" } // User123!
            );
            return modelBuilder;
        }
        #endregion
