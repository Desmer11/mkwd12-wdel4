...
namespace Lamazon.Web.Controllers
{
    ...
    public class OrdersController : BaseController
    {
        ...
        public OrdersController(IProductService productService, IOrderService orderService, IGeoTrackerService geoTrackerService)
        {
        ...
        public async Task<IActionResult> CreateOrder(List<OrderLineItemViewModel> orderLineItems)
        {
            ...
            orderViewModel.IpAddress = ipAddress != null ? ipAddress.ToString() : "77.28.200.111";
            ...
            orderViewModel.CountryFlagUrl = _geoTrackerService.GetCoutryFlagUrl(ipGeoInfo.CountryCode);
